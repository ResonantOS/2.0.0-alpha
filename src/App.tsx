  ...
  const sendStrategistMessage = async (overrideMessage?: string) => {
    ...
    try {
      await executeChatTurn({
        ...
        overrideMessage,
        commitReadyState,
        getLatestState: () => currentReadyStateRef.current ?? state,
        setComposer,
        setAttachments,
        setChatNotice,
        setChatBusy,
  ...
  const sendLivingArchiveAgentMessage = async (message: string, contextPrompt?: string) => {
    ...
    try {
      await executeChatTurn({
        ...
        commitReadyState,
        getLatestState: () => currentReadyStateRef.current ?? stateWithThread,
        setComposer,
        setAttachments,
        setChatNotice,
        setChatBusy,
  ...
  const startArchivePreflightAugmentorSession = async (report: ArchiveLibraryPreflightResult) => {
    ...
    try {
      await executeChatTurn({
        ...
        commitReadyState,
        getLatestState: () => currentReadyStateRef.current ?? nextState,
        setComposer,
        setAttachments,
        setChatNotice,
        setChatBusy,

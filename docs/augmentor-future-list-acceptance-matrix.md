...
| Reasoning-trace / durable job trace | FL-33 | #225 CLOSED · PR #302 MERGED | ✅ supported report construction/redaction and archive-request foundation | `browser-first/test/control-reporting-service.test.mjs` lines 130–163 and 232–283 tests redaction, report progress calculation, and mocked archive handoff; `browser-first/test/trace-redaction.test.mjs` lines 6–81 exercises redaction; `browser-first/test/monitor-renderers.test.mjs` line 158 tests progress rendering in a harness. | archive requests and calculated progress do not prove storage durability or fresh live UI behavior |
...
| Capability | FL | Canonical issue(s) | Status | Tests / proof | Safety boundary |
|---|---|---|---|---|---|
| Consent / dry-run / history / kill-switch | FL-38, FL-40 | #116, #224, #240, #226 CLOSED · #246, #234, #243–#245, #249, #253 OPEN | 🔒 safety-constrained; bounded existing controls plus deferred requirements | `browser-first/test/task-consent-store.test.mjs` lines 36–99 tests scoped consent, expiry/revocation; `browser-first/test/content-redaction.test.mjs` lines 665 and 872 tests field boundaries; `browser-first/test/agent-control-runner.test.mjs` lines 477–520 and 681 tests safe consent/preflight and cancellation. **Required:** deferred recurring/draft/packet/voice controls. | consent cannot override human-only wallet/signing/payment/checkout/reservation/public-submit/credential/login actions |

...
| [ADR-039: Ground-0 Recovery Contract](ADR-039-ground0-recovery-contract.md)                                                   | Deferred        | Deferred            | -                                                                            | Core and add-ons         | Proposed Phase 1 direction; defines the recoverable baseline and D8 acceptance tests; no recovery implementation by this decision.                             |
| [ADR-040: Authority Plane Invariants](ADR-040-authority-plane-invariants.md)                                                  | Deferred        | Deferred            | -                                                                            | Core and add-ons         | Proposed Phase 1 direction; names the Authority Plane and its authoritative invariant; no authority relocation by this decision.                               |

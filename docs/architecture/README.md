...
| [ADR-039: Ground-0 Recovery Contract](ADR-039-ground0-recovery-contract.md)                                                   | Proposed        | Deferred            | -                                                                            | Core and add-ons         | Proposed Phase 1 direction; defines the recoverable baseline and its acceptance tests; no recovery implementation by this decision.                            |
| [ADR-040: Authority Plane Invariants](ADR-040-authority-plane-invariants.md)                                                  | Proposed        | Deferred            | -                                                                            | Core and add-ons         | Proposed Phase 1 direction; names the Authority Plane and its invariant; no authority relocation by this decision.                                             |

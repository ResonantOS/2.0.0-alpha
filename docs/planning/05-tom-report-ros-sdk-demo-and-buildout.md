...
| Invariant-path review      | Not captured                                            | Proposed two-person review on invariant paths (§13.10) — a working assumption, not yet applied (per ADR-038).                                                                                                                                                                                                                                  | Working assumption (not applied) |
